...
public enum MethodEnum implements Serializable {
    ...
    CALCULATED_WEIGHT_LENGTH(47, "CALCULATED_WEIGHT_LENGTH"), // ID from SIH-Harmonie
    CALCULATED_WEIGHT_LENGTH_SUM(283, "CALCULATED_WEIGHT_LENGTH_SUM"), // ID from SIH-Harmonie
    ;
