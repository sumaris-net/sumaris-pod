...
@Data
@Entity
@Table(name = "file_ices_species_list")
public class FileIcesSpeciesList implements Serializable, IEntityBean<Integer> {

    public static final DatabaseTableEnum TABLE = DatabaseTableEnum.FILE_ICES_SPECIES_LIST;
