 ...
 *
 * On distingue plusieurs types de regroupements de taxons :<ul>
 *   <li>les groupes descriptifs des taxons, et utilisés à l'extraction des données (groupes écologiques par exemple)</li>
