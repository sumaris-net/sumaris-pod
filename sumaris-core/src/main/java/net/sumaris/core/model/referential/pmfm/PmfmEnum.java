...
public enum PmfmEnum implements IEntityEnum, Serializable {
    ...
    // P03 SFA ID FROM SIH_ADAGIO
    GEAR_PHYSICAL_HOOK_NUMBER(84, "GEAR_PHYSICAL_HOOK_NUMBER"),
    GEAR_PHYSICAL_GEAR_NUMBER(253, "GEAR_PHYSICAL_GEAR_NUMBER"),

    BIOLOGICAL_WEIGHT(164, "BIOLOGICAL_WEIGHT"),
    BIOLOGICAL_LENGTH(349, "BIOLOGICAL_LENGTH"),
    CREW_SIZE(350, "CREW_SIZE"),
    DECLARATIVE_DOCUMENT(351, "CREW_SIZE"),
    INACTIVITY_REASON(352, "INACTIVITY_REASON"),
    SALE_AMOUNT(353, "SALE_AMOUNT"),
    CONDITIONNEMENT(354, "CONDITIONNEMENT"),

    PRODUCT_AVG_PRICE(359, "PRODUCT_AVG_PRICE"),
    PRODUCT_AVG_PRICE_UNIT(355, "PRODUCT_AVG_PRICE_UNIT"),
    PRODUCT_AVG_PRICE_VOLUME(356, "PRODUCT_AVG_PRICE_VOLUME"),
    PRODUCT_AVG_PRICE_DOZEN(357, "PRODUCT_AVG_PRICE_DOZEN"),
    PRODUCT_AVG_PRICE_HUNDRED(358, "PRODUCT_AVG_PRICE_HUNDRED"),
    PRODUCT_AVG_PRICE_PIECE(359, "PRODUCT_AVG_PRICE_PIECE"),

    LANDING_COST(46, "LANDING_COST"),
    ICE_COST(44, "ICE_COST"),
    BAIT_COST(29, "BAIT_COST"),
    FOOD_COST(35, "FOOD_COST"),
    GEAR_LOST_COST(51, "GEAR_LOST_COST"),
    FUEL_COST(242, "FUEL_COST"),
    OTHER_COST(254, "OTHER_COST"),

    FUEL_VOLUME(40, "FUEL_VOLUME"),
    FUEL_UNIT_PRICE(244, "FUEL_UNIT_PRICE"),
    FUEL_TYPE(37, "FUEL_TYPE"),

    ENGINE_OIL_VOLUME(34, "ENGINE_OIL_VOLUME"),
    ENGINE_OIL_UNIT_PRICE(33, "ENGINE_OIL_UNIT_PRICE"),
    ENGINE_OIL_COST(32, "ENGINE_OIL_COST"),

    HYDRAULIC_OIL_VOLUME(43, "HYDRAULIC_OIL_VOLUME"),
    HYDRAULIC_OIL_UNIT_PRICE(42, "HYDRAULIC_OIL_UNIT_PRICE"),
    HYDRAULIC_OIL_COST(41, "HYDRAULIC_OIL_COST"),

    BAIT_TYPE(30, "BAIT_TYPE"),
    BAIT_WEIGHT(241, "BAIT_WEIGHT"),
    BAIT_PACKET_COUNT(300, "BAIT_PACKET_COUNT"),
    BAIT_BAG_COUNT(303, "BAIT_BAG_COUNT"),
    BAIT_UNIT_COUNT(344, "BAIT_UNIT_COUNT"),
