...
public enum PmfmEnum implements Serializable  {
    ...
    AVERAGE_WEIGHT_PRICE(271, "AVERAGE_WEIGHT_PRICE"),
    AVERAGE_VOLUME_PRICE(273, "AVERAGE_VOLUME_PRICE"),
    AVERAGE_UNIT_PRICE(274, "AVERAGE_UNIT_PRICE"),
    AVERAGE_DOZEN_PRICE(275, "AVERAGE_DOZEN_PRICE"),
    AVERAGE_HUNDRED_PRICE(276, "AVERAGE_HUNDRED_PRICE"),
    AVERAGE_PIECES_PRICE(347, "AVERAGE_PIECES_PRICE"),
