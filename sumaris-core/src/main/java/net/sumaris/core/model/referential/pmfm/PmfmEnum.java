...
public enum PmfmEnum implements Serializable {
    ...
    BATCH_CALCULATED_WEIGHT_LENGTH(223, "BATCH_CALCULATED_WEIGHT_LENGTH"), // RTP Weight (ID from SIH-Harmonie)
    BATCH_CALCULATED_WEIGHT_LENGTH_SUM(1152, "BATCH_CALCULATED_WEIGHT_LENGTH_SUM"), // Sum of RTP weights (ID from SIH-Harmonie)
