...
public enum PmfmEnum implements IEntityEnum, Serializable {
    ...
    CIRCUMFERENCE_CM(399, "CIRCUMFERENCE_CM"),
    ...
    // Activity Calendar
    SURVEY_QUALIFICATION(446, "SURVEY_QUALIFICATION"), // Adagio ID = 623
    SURVEY_RELIABILITY(447, "SURVEY_RELIABILITY"), // 681
    DURATION_AT_SEA_DAYS(449, "DURATION_AT_SEA_DAYS"), // 241
    ...
    CAMERA_USED(1036, "CAMERA_USED"),
    LINE_LAYOUT(1038, "LINE_LAYOUT"),
    LINE_LAYOUT_LINEAR(1039, "LINE_LAYOUT_LINEAR"),
    LINE_LAYOUT_ZIGZAG(1040, "LINE_LAYOUT_ZIGZAG"),
    LINE_LAYOUT_UNKNOWN(1041, "LINE_LAYOUT_UNKNOWN"),
    DECOMPOSITION_STATE(1046, "DECOMPOSITION_STATE"),
    IS_TANGLED(1033, "IS_TANGLED"),
    PINGER_ACCESSIBLE(1040, "PINGER_ACCESSIBLE"),
    ;
