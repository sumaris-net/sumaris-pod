...
@FieldNameConstants
@Entity
@Table(name = "gear_physical_features_origin")
public class GearPhysicalFeaturesOrigin implements Serializable {
    ...
    @Id
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "gear_physical_features_fk", nullable = false)
    @EqualsAndHashCode.Include
