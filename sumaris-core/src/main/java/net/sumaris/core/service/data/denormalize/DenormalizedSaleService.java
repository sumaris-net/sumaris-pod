...
public interface DenormalizedSaleService {
    ...
    @Transactional(readOnly = true)
    DenormalizedBatchOptions createOptionsBySale(@NonNull SaleVO sale,
                                                 @Nullable DenormalizedBatchOptions inheritedOptions);

    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    DenormalizedSaleResultVO denormalizeByFilter(@NonNull SaleFilterVO filter, @Nullable DenormalizedBatchOptions options);
