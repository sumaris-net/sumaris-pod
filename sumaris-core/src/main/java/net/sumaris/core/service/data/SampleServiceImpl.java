...
public class SampleServiceImpl implements SampleService {
    ...
    public SampleVO save(SampleVO sample) {
        ...
        if (result.hasNotFlag(ValueObjectFlags.SAME_HASH)) {
            ...
            // Save images
            if (enableImages) saveImageAttachments(result);
        }
    ...
    private void saveImageAttachments(SampleVO source) {
        List<ImageAttachmentVO> images = Beans.getList(source.getImages());
        images.forEach(image -> fillDefaultProperties(source, image));
        images = imageAttachmentService.saveAllByParent(images, source, ObjectTypeEnum.SAMPLE);
    ...
    protected void fillDefaultProperties(SampleVO parent, ImageAttachmentVO image) {
