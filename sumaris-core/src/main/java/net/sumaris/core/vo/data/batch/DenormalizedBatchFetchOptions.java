...
public class DenormalizedBatchFetchOptions implements IDataFetchOptions {

    public static final DenormalizedBatchFetchOptions DEFAULT = DenormalizedBatchFetchOptions.builder().build();

    @Builder.Default
    private boolean withChildrenEntities = true;
