...
public class CacheConfiguration {
    ...
    public EhCacheFactoryBean pmfmByStrategyIdCache() {
        return Caches.createHeapCache(ehcache(), CacheNames.PMFM_BY_FILTER, CacheDurations.DEFAULT, CacheDurations.DEFAULT, 500);
    }


    @Bean
    public EhCacheFactoryBean denormalizedPmfmByStrategyIdCache() {
        return Caches.createHeapCache(ehcache(), CacheNames.DENORMALIZED_PMFM_BY_FILTER, CacheDurations.DEFAULT, CacheDurations.DEFAULT, 500);
    }
