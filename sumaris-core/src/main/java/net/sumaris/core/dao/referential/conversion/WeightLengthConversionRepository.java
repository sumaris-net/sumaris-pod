...
public interface WeightLengthConversionRepository extends SumarisJpaRepository<WeightLengthConversion, Integer, WeightLengthConversionVO>,
    WeightLengthConversionSpecifications {
