...
public interface DailyActivityCalendarRepository extends
    RootDataRepository<DailyActivityCalendar, DailyActivityCalendarVO, DailyActivityCalendarFilterVO, DailyActivityCalendarFetchOptions>,
    DailyActivityCalendarSpecifications {

    @Query("select p.id from DailyActivityCalendar t inner join t.program p where t.id = :id")
