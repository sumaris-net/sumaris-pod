...
public interface VesselPositionDao {
    ...
    VesselPositionVO save(VesselPositionVO source);

    List<VesselPositionVO> saveByOperationId(int operationId, List<VesselPositionVO> source);

    VesselPositionVO toMeasurementVO(VesselPosition vesselPosition);
}
