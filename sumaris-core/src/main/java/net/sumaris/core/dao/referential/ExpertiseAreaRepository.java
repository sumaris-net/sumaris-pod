...
public interface ExpertiseAreaRepository
    extends ReferentialRepository<Integer, ExpertiseArea, ExpertiseAreaVO, ReferentialFilterVO, ExpertiseAreaFetchOptions>,
    ReferentialSpecifications<Integer, ExpertiseArea> {
}
