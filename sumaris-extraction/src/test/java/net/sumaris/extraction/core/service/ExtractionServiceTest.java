...
//        Assert.assertTrue(countLineInCsvFile(speciesLengthFile) > 1);
    ...
    public void executeTripTest(List<ExtractionFilterCriterionVO> criteria) throws IOException {
        ...
        try {
            ...
            // T.csv
            File monitoringFile = new File(root, ObservedLocationSpecification.TRIP_SHEET_NAME + ".csv");
            Assert.assertTrue(countLineInCsvFile(monitoringFile) > 1);
    ...
    public void executeTripCalendarTest(List<ExtractionFilterCriterionVO> criteria) throws IOException {
        ...
        try {
            ...
            // T.csv
            File monitoringFile = new File(root, ObservedLocationSpecification.TRIP_CALENDAR_SHEET_NAME + ".csv");
            Assert.assertTrue(countLineInCsvFile(monitoringFile) > 1);
    ...
    public void executeObserverTest(List<ExtractionFilterCriterionVO> criteria) throws IOException {
        IExtractionType type = LiveExtractionTypeEnum.OBSERVED_LOCATION;
        if (CollectionUtils.isEmpty(criteria)) {
            criteria = new ArrayList<>();
            criteria.add(
        ...
        try {
            ...
            // T.csv
            File monitoringFile = new File(root, ObservedLocationSpecification.OBSERVER_SHEET_NAME + ".csv");
            Assert.assertTrue(countLineInCsvFile(monitoringFile) > 1);
    ...
    public void executeVariableCostTest(List<ExtractionFilterCriterionVO> criteria) throws IOException {
        IExtractionType type = LiveExtractionTypeEnum.OBSERVED_LOCATION;
        if (CollectionUtils.isEmpty(criteria)) {
            criteria = new ArrayList<>();
            criteria.add(
        ...
        try {
            ...
            // T.csv
            File monitoringFile = new File(root, ObservedLocationSpecification.VARIABLE_COST_SHEET_NAME + ".csv");
            Assert.assertTrue(countLineInCsvFile(monitoringFile) > 1);
