...
public class ExtractionActivityMonitoringDaoImpl<C extends ExtractionActivityMonitoringContextVO, F extends ExtractionFilterVO>
    ...
    protected XMLQuery createCalendarQuery(C context) throws PersistenceException {
        ...
        if (context.getDirectSurveyInvestigation() != null) {
            xmlQuery.setGroup("directSurveyInvestigationFilter", true);
            xmlQuery.bind("directSurveyInvestigation", context.getDirectSurveyInvestigation());
        } else {
            xmlQuery.setGroup("directSurveyInvestigationFilter", false);
        }
