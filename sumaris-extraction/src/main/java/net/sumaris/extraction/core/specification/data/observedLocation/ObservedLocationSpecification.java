...
public interface ObservedLocationSpecification {
    ...
    String[] SHEET_NAMES = {OL_SHEET_NAME, VESSEL_SHEET_NAME, CATCH_SHEET_NAME, CATCH_INDIVIDUAL_SHEET_NAME, CATCH_LOT_SHEET_NAME, TRIP_SHEET_NAME, TRIP_CALENDAR_SHEET_NAME, OBSERVER_SHEET_NAME, SALE_SHEET_NAME, VARIABLE_COST_SHEET_NAME, OPERATION_SHEET_NAME};

    // For DEBUG only
    String[] SHEET_NAMES_DEBUG = {OL_SHEET_NAME, VESSEL_SHEET_NAME, CATCH_SHEET_NAME, CATCH_INDIVIDUAL_SHEET_NAME, CATCH_LOT_SHEET_NAME, TRIP_SHEET_NAME, TRIP_CALENDAR_SHEET_NAME, OBSERVER_SHEET_NAME, SALE_SHEET_NAME, VARIABLE_COST_SHEET_NAME, OPERATION_SHEET_NAME};
