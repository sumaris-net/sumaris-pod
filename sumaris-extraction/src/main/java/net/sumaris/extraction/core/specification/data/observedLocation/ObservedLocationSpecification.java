...
public interface ObservedLocationSpecification {
    ...
    String COLUMN_PROGRAM = "programme";
    ...
    String COLUMN_START_DATE = "date_debut";
    String COLUMN_END_DATE = "date_fin";

    String COLUMN_MONTH_PREFIX = "month";

    String[] SHEET_NAMES = {OL_SHEET_NAME, VESSEL_SHEET_NAME, TRIP_SHEET_NAME, OBSERVER_SHEET_NAME, OPERATION_SHEET_NAME, CATCH_SHEET_NAME, CATCH_INDIVIDUAL_SHEET_NAME, CATCH_LOT_SHEET_NAME, SALE_SHEET_NAME, VARIABLE_COST_SHEET_NAME, TRIP_CALENDAR_SHEET_NAME};


    // For DEBUG only
    String[] SHEET_NAMES_DEBUG = {OL_SHEET_NAME, VESSEL_SHEET_NAME, TRIP_SHEET_NAME, OBSERVER_SHEET_NAME, OPERATION_SHEET_NAME, CATCH_SHEET_NAME, CATCH_INDIVIDUAL_SHEET_NAME, CATCH_LOT_SHEET_NAME, SALE_SHEET_NAME, VARIABLE_COST_SHEET_NAME, TRIP_CALENDAR_SHEET_NAME};
