...
@Component("taxrefRdfTaxonDao")
public class TaxrefRdfTaxonDaoImpl extends BaseRdfTaxonDaoImpl {

    private static final Logger log = LoggerFactory.getLogger(TaxrefRdfTaxonDaoImpl.class);
