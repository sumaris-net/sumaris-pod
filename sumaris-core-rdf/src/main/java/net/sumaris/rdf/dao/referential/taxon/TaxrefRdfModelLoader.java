...
@Component("taxrefRdfModelLoader")
public class TaxrefRdfModelLoader extends AbstractNamedRdfModelLoader {

    private static final Logger log = LoggerFactory.getLogger(TaxrefRdfModelLoader.class);
