...
// have .id set to the id of the variable being assigned to.
...
var ReactClass = {
  ...
  createClass: function (spec) {
    ...
    // ensure that Constructor.id !== 'Constructor'. This makes sure we don't
...
// Returns class id of the object, if any.
