...
public class DataGraphQLService {
    ...
    protected ActivityCalendarVO fillActivityCalendarFields(ActivityCalendarVO activityCalendar, Set<String> fields) {
        ...
        fillActivityCalendarsFieldVesselRegistrationPeriods(activityCalendar, fields);
    ...
    protected List<ActivityCalendarVO> fillActivityCalendarsFields(List<ActivityCalendarVO> activityCalendars, Set<String> fields) {
        ...
        activityCalendars.forEach((activityCalendar) -> fillActivityCalendarsFieldVesselRegistrationPeriods(activityCalendar, fields));

        return activityCalendars;
    }

    protected ActivityCalendarVO fillActivityCalendarsFieldVesselRegistrationPeriods(ActivityCalendarVO activityCalendar, Set<String> fields) {
