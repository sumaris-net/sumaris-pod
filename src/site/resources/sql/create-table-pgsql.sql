...
create table software_property (id int4 not null, creation_date timestamp not null, label varchar(255) not null, name varchar(2000) not null, update_date timestamp, software_fk int4 not null, status_fk int4 not null, object_type_fk int4, object_id int4, primary key (id));
...
alter table if exists software_property add constraint software_property_object_type_fkc foreign key (object_type_fk) references object_type;
