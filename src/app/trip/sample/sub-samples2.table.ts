...
export class SubSamples2Table extends AppMeasurementsTable<Sample, SubSampleFilter>
  ...
  constructor(
    ...
    super(injector,
      ...
      injector.get(ValidatorService),
      {
        ...
        reservedStartColumns: SubSamples2Table.RESERVED_START_COLUMNS,
        reservedEndColumns: SubSamples2Table.RESERVED_END_COLUMNS
      }
    );
