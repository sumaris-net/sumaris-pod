...
@Component({
  selector: 'app-operation-group-page',
  templateUrl: './operation-group.page.html',
  styleUrls: ['./operation-group.page.scss'],
  animations: [fadeInOutAnimation],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class OperationGroupPage extends AppEditorPage<Operation, OperationFilter> implements OnInit, AfterViewInit {
  ...
  @ViewChild('opeForm', { static: true }) opeForm: OperationGroupForm;
    ...
    this.registerSubscription(
      this.programSubject.asObservable()
        .pipe(
          ...
          switchMap(programLabel => this.programService.watchByLabel(programLabel, {toEntity: true}))
        )
