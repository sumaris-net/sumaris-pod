...
import {Batch, PmfmStrategy, referentialToString, Sample, TaxonGroupIds} from "../services/trip.model";
import {
  PmfmIds,
  QualitativeLabels,
...
import {SubSampleFilter} from "../sample/sub-samples2.table";
...
export class SubBatches2Table extends AppMeasurementsTable<Batch, SubBatchFilter>
  ...
  constructor(
    ...
    super(injector,
      ...
      new InMemoryTableDataService<Batch, SubBatchFilter>(Batch, {
        ...
        onLoaded: (data) => this.linkDataToParent(data)
      }),
      injector.get(ValidatorService),
      {
        prependNewElements: false,
        suppressErrors: false,
        reservedStartColumns: SubBatches2Table.RESERVED_START_COLUMNS,
        reservedEndColumns: SubBatches2Table.RESERVED_END_COLUMNS
      }
    );
