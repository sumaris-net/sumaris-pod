...
import { Referential, Operation, Trip, referentialToString, PhysicalGear, GearLevelIds, Measurement } from "../../services/model";
...
import { PhysicalGearForm } from "../form/form-physical-gear";


@Component({
  selector: 'table-physical-gears',
  templateUrl: 'table-physical-gears.html',
  styleUrls: ['table-physical-gears.scss'],
  providers: [
