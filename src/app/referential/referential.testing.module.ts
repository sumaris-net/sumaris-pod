...
export const REFERENTIAL_TESTING_PAGES = [<TestingPage>{ label: 'Pmfm Strategies Table', page: '/testing/referential/pmfmStrategiesTable' }];
...
@NgModule({
  imports: [CommonModule, SharedModule, CoreModule, TranslateModule.forChild(), RouterModule.forChild(routes), AppReferentialModule],
