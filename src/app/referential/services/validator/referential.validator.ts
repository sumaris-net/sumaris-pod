...
import { AppValidatorService, Referential } from '@sumaris-net/ngx-components';

@Injectable({ providedIn: 'root' })
export class ReferentialValidatorService<T extends Referential = Referential> extends AppValidatorService<T> {
