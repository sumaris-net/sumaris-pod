...
{
  protected constructor(protected formBuilder: FormBuilder, @Optional() protected settings?: LocalSettingsService) {}
  ...
  getFormGroup(data?: T, opts?: O): FormGroup {
    ...
    return this.formBuilder.group(this.getFormGroupConfig(data, opts), this.getFormGroupOptions(data));
  }
