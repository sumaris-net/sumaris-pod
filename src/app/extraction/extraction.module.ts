...
@NgModule({
  imports: [CommonModule, LeafletModule, TranslateModule.forChild(), MarkdownModule.forChild(), ChartsModule, AppCoreModule, AppReferentialModule],
  declarations: [ProductPage, ProductForm, SelectProductModal, ExtractionTablePage, ExtractionMapPage, ExtractionCriteriaForm, ExtractionHelpModal],
