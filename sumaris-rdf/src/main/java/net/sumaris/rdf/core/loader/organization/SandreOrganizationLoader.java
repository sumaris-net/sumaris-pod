...
package net.sumaris.rdf.core.loader.organization;
...
@Component("sandreOrganizationRdfLoader")
@Slf4j
public class SandreOrganizationLoader extends AbstractNamedRdfLoader {
    ...
    @Value("${rdf.dataset.sandre.inc.query:classpath:sparql/sandre-organization.sparql}")
